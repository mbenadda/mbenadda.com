...
It is particularly helpful to add TypeScript to an existing project without being overcome by compiler errors. Or to gradually introduce your teammates to it.

Later on, it will also enable any new *strictness* options that are added to the compiler. Which means you're assured to get them when you upgrade TypeScript.
...
explicitly define the assumptions we make. You can do it like `this`:
